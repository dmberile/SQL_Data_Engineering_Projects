...
![EDA Project Overview](https://github.com/dmberile/SQL_Data_Engineering_Projects/blob/main/1_EDA/Images/1_1_Project1_EDA.png?raw=true)
...
1. [`01_top_demanded_skills.sql`](https://github.com/dmberile/SQL_Data_Engineering_Projects/blob/main/1_EDA/01_top_demanded_skills.sql) – demand analysis with multi-table joins  
2. [`02_top_paying_skills.sql`](https://github.com/dmberile/SQL_Data_Engineering_Projects/blob/main/1_EDA/02_top_paying_skills.sql) – salary analysis with aggregations  
3. [`03_optimal_skills.sql`](https://github.com/dmberile/SQL_Data_Engineering_Projects/blob/main/1_EDA/03_most_optimal_skills.sql) – combined demand/salary optimization query  
...
3. [`03_Most_optimal_skills.sql`](1_EDA/03_most_optimal_skills.sql) – combined demand/salary optimization query  
...
![Data Warehouse Schema](https://github.com/dmberile/SQL_Data_Engineering_Projects/blob/main/1_EDA/Images/1_2_Data_Warehouse.png?raw=true)
...
1. **[Top Demanded Skills](https://github.com/dmberile/SQL_Data_Engineering_Projects/blob/main/1_EDA/01_top_demanded_skills.sql)** – Identifies the 10 most in-demand skills for remote data engineer positions
2. **[Top Paying Skills](https://github.com/dmberile/SQL_Data_Engineering_Projects/blob/main/1_EDA/02_top_paying_skills.sql)** – Analyzes the 25 highest-paying skills with salary and demand metrics
3. **[Optimal Skills](./https://github.com/dmberile/SQL_Data_Engineering_Projects/blob/main/1_EDA/03_most_optimal_skills.sql)** – Calculates an optimal score using natural log of demand combined with median salary to identify the most valuable skills to learn
